...
\section{Experience}
\cventry{2012--Present}{Research assistant (PhD)}{\textit{Research}}{OIST, Japan}{}{Researching theory of cold atomic quantum systems. Experience in linear algebra, multivariate calculus, differential equations, analysis, probability theory, and numerical algorithms. Computational modeling, analytical, and numerical solution of problems using \textsc{MATLAB}, Mathematica, C/C++, CUDA, Python, Julia, and pencil \& paper.}{}
...
\cventry{2010--2011}{Software developer}{\textit{Working}}{IBM, Ireland}{}{Developed software for IBM WebSphere Portal Server. Experience with Java, XML, XLST, Python, Shell. Further information available upon request.}
\cventry{2009}{Product engineer}{\textit{Internship}}{Analog Devices BV, Ireland}{}{Analysis of semiconductor device yields and failures. Further information available upon request.}

\section{Software engineering experience}
\cvline{}{I have developed research codes for various topics such as data analysis, high performance computing simulations of quantum systems, and tomographic image processing. Currently, I have worked with C/C++, CUDA, Python, \textsc{MATLAB}, OpenCL, Julia, Mathematica, Shell (Bash/Zsh), \LaTeX, and Java. Listed below are a subset of projects that I have written, and are available on GitHub.}
\cvline{GPUE}{GPU computing enabled Gross--Pitaevskii equation solver; a pseudo-spectral linear and nonlinear partial differential equation solver and simulation tool for superfluid dynamics. Languages: CUDA, C/C++, Python, \textsc{MATLAB}, Shell. Available at \href{http://github.com/gpue-group/gpue}{gpue-group/gpue}. All data from the above publications were generated using this tool. Publication on this tool in preparation.}
...
\cvline{hexacorr}{Correlation functions for 2D spatial data. Used extensively in published works above. Language: \textsc{MATLAB}. Available at \href{http://github.com/mlxd/hexacorr}{GH/mlxd/hexacorr}.}
...
\cvline{0-2 years}{\small HTML, C\#, Visual Basic, MPI, Javascript, OpenCL}
\cvline{2-4 years}{\small Python, Java, OpenMP, Mathematica, Bash/Zsh, {\LaTeX}, Julia.}
\cvline{4+ years}{\small C/C++, CUDA, \textsc{MATLAB}.}
\cvline{}{}
