...
\moderncvtheme[grey]{banking}                % oldstyle banking casual classic
...
\cventry{2011--2012}{PhD in Physics}{Ultracold Quantum Gases group, University College Cork}{Ireland}{}{Transferred to Okinawa Institute of Science and Technology Graduate University, Japan.}
\cventry{2006--2010}{BSc (Hons) in Physics with Computing}{Waterford Institute of Technology}{Ireland}{First class honours}{}

\section{Experience}
\cventry{2013--2015}{MATLAB instructor}{\textit{Teaching}}{Okinawa Institute of Science and Technology Graduate University, Japan}{}{Created and delivered a two day crash course in MATLAB programming as part of a team.}
\cventry{2011--2012}{Laboratory teaching assistant}{\textit{Teaching}}{University College Cork, Ireland}{}{Organised, guided and demonstrated undergraduate laboratory sessions in physics experiments.}
\cventry{2010--2011}{Software engineer}{\textit{Working}}{IBM, Ireland}{}{Development of server-side applications for use with WebSphere Portal platform. Experience using Java, J2EE, XML, XSLT, Ant, Shell scripting, JDBC, Python, C.}
\cventry{2009}{Product engineer (intern)}{\textit{Working}}{Analog Devices BV, Ireland}{}{Semiconductor device yield improvement team. Hardware and software analysis and development.}
...
\cvline{CUDA,C/C++\\Python,Matlab}{Architect \& developer of GPUE: Bose-Einstein condensation simulation suite on GPU. Available at GPUE - \href{http://github.com/mlxd/gpue}{http://github.com/mlxd/gpue}.}
\cvline{Multiple languages}{Various projects for improving coding skills in computational sciences, available at\newline{} \href{http://github.com/mlxd}{http://github.com/mlxd}.}
