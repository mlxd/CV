...
\section{Education}
\cventry{2012--2017}{PhD in Science (Physics)}{Quantum Systems Unit, Okinawa Institute of Science and Technology Graduate University (OIST)}{Japan}{}{Dissertation title: ``Non-equilibrium vortex dynamics in rapidly rotating Bose-Einstein condensates''.}
...
\cventry{2006--2010}{BSc (Hons) in Physics with Computing}{Waterford Institute of Technology (WIT)}{Ireland}{First class honours}{Dissertation title: ``Evaluating magnetic susceptibility in Heisenberg chains using OpenCL implementations of Monte Carlo methods''.}
...
\cvline{Languages}{\small C/C++, CUDA, \textsc{MATLAB}, Python, Java, MPI, OpenMP, Mathematica, Bash/Zsh, {\LaTeX}, Julia, HTML, C\#, Visual Basic, Javascript, OpenCL.}
\cvline{}{Listed below are a subset of projects that I have contributed to:}
...
%\iffalse
\section{Peer-reviewed publication list}
...
\cventry{Ongoing}{Professional memberships}{}{}{}{American Physical Society (APS), Institute of Physics (IOP), Association for Computing Machinery (ACM) SIGHPC.}{}
\cventry{Ongoing}{Referee}{}{}{}{IOP Journals, Journal of Open Source Software (JOSS).}{}


%iffalse
\section{Presentations}
\cventry{Apr, 2017}{Waterford Insitute of Technology} {Invited talk}{Waterford}{Ireland}{Oral presentation: ``\textit{Non-equilibrium vortex dynamics in rapidly rotating Bose-Einstein condensates}"}
