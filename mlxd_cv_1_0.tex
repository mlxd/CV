...
\extrainfo{\href{http://loriordan.netlify.com}{https://loriordan.netlify.com}}
...
\cventry{2006--2010}{BSc (Hons) in Physics with Computing}{Waterford Institute of Technology}{Ireland}{}{Thesis: \emph{``Evaluating magnetic susceptibility in Heisenberg chains using OpenCL implementations of Monte Carlo methods.''}} %{Thesis: \emph{``Evaluating magnetic susceptibility in Heisenberg chains using OpenCL implementations of Monte Carlo methods''}.}
...
\section{Work experience}
    \cventry{2019--Current}{Research computational scientist}{}{Irish Center for High End Computing (ICHEC)}{Ireland}{Implementing natural language processing (NLP) models on near-term quantum architectures.}
    ...
    \cventry{2010--2011}{Software developer}{}{IBM Ireland}{Dublin, Ireland}{Developed server-side applications for use with WebSphere Portal platform. Developed solutions using Java, XML, XSLT, Ant, Shell scripting, JDBC, Python, C. Deployed and managed WebSphere Portal, Lotus Sametime, and Lotus Connections software stacks.}
    \cventry{2009}{Product engineer (intern)}{}{Analog Devices BV}{Limerick, Ireland}{Member of semiconductor device yield improvement team. Analysed and implemented strategies for device failure analysis. Developed software for die yield analysis and characterisation.
}

\section{Software development experience}
    \cvline{\textbf{QNLP Project}}{Developing scalable models for natural language processing using the Intel qHiPSTER quantum simulator. Languages \& technologies: C++, MPI, Python.}
...
\section{University service}
    \cventry{2017-Current}{Board member}{Board of Councilors}{OIST, Japan}{}{}{}
...
\cvline{2019}{
    \textbf{{Chaotic few-body vortex dynamics in rotating Bose-Einstein condensates}},
    {T.~Zhang, J.~Schloss, A.~Thomasen, L.~J.~O'Riordan, T.~Busch, A.~White},
    {Physical Review Fluids, (\textbf{4}) 5, 054701 (2019)}. DOI: {\href{https://doi.org/10.1103/PhysRevFluids.4.054701}{10.1103/PhysRevFluids.4.054701} }
}

\cvline{2018}{
    \textbf{{GPUE: Graphics Processing Unit Gross-Pitaevskii Equation solver}},
    {J.~R.~Schloss, L.~J.~O'Riordan},
    {Journal of Open Source Software, (\textbf{3}) 32, 1037 (2018)}. DOI: {\href{https://doi.org/10.21105/joss.01037}{10.21105/joss.01037} }
}
...
\section{Presentations, talks and tutorials}
    \cventry{Jun, 2019}{ISC 2019} {Talk/technical session}{Frankfurt}{Germany}{Title: ``\emph{Natural language processing with Intel\textregistered~Quantum Simulator}"}
    \cventry{Mar, 2018}{DIALS Workshop 2018} {Talk/tutorial}{Lawrence Berkeley National Lab}{USA}{Title: ``\emph{Data analysis and development using Jupyter}"}
    ...
    \cventry{Oct, 2015}{SkillPill} {Tutorial}{OIST}{Japan}{Tutorial session: ``\emph{Accelerating MATLAB}"}
    \cventry{Jun, 2015}{ICOLS 2015} {Conference}{Sentosa}{Singapore}{Poster presentation: ``\emph{Moiré super-lattice in a kicked rapidly rotating Bose–Einstein condensate}"}
