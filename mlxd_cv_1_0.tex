...
\cvline{2018}{\textit{``Improving signal strength in serial crystallography with DIALS geometry refinement'', }{A.~S.~Brewster, D.~G.~Waterman, J.~M.~Parkhurst, R.~J.~Gildea, I.~D.~Young, L.~J.~O'Riordan, J.~Yano, G.~Winter, G.~Evans, N.~K.~Sauter.} {Acta Cryst. (2018). D74, 877-894}. }
...
\cventry{Mar, 2018}{DIALS Workshop 2018} {Talk}{Lawrence Berkeley National Lab}{USA}{Title: ``\textit{Data analysis and development using Jupyter}"}
